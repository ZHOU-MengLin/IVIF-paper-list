...
| **Year** | **Title**[code]                                              | Test               | Journal         |
| :------: | :----------------------------------------------------------- | ------------------ | --------------- |
| **2025** | [GIFNet: One Model for ALL: Low-Level Task Interaction Is a Key to Task-Agnostic Image Fusion](https://github.com/AWCXV/GIFNet) | :white_check_mark: | CVPR            |
| **2025** | [DCEvo: Discriminative Cross-Dimensional Evolutionary Learning for Infrared and Visible Image Fusion](https://github.com/Beate-Suy-Zhang/DCEvo) |                    | CVPR            |
| **2025** | [Every SAM Drop Counts: Embracing Semantic Priors for Multi-Modality Image Fusion and Beyond](https://github.com/RollingPlain/SAGE_IVIF) |                    | CVPR            |
| **2025** | [Task-driven Image Fusion with Learnable Fusion Loss](https://github.com/HaowenBai/TDFusion) |                    | CVPR            |
| **2025** | [MaeFuse: Transferring Omni Features with Pretrained Masked Autoencoders for Infrared and Visible Image Fusion via Guided Training](https://github.com/Henry-Lee-real/MaeFuse) | :white_check_mark: | TIP             |
| **2025** | [DAF-Net: A Dual Attention Fusion Network with Window-Guided Attention and Invertible Modules for Infrared-Visible Image Fusion](https://github.com/xujian000/DAF-Net) | :white_check_mark: | ICCECE          |
| **2025** | [DDBFusion: An unified image decomposition and fusion framework based on dual decomposition and B ́ezier curves.](https://github.com/Yukarizz/DDBFusion) | :white_check_mark: | InfFus          |
| **2025** | [Text-DiFuse: An Interactive Multi-Modal Image Fusion Framework based on Text-modulated Diffusion Model](https://github.com/Leiii-Cao/Text-DiFuse) | :white_check_mark: | **NeurIPS**     |
| **2025** | [A degradation-aware guided fusion network for infrared and visible image](https://github.com/wang-x-1997/DAFusion) | :white_check_mark: | InfFus          |
| **2025** | [SAM-guided multi-level collaborative Transformer for infrared and visible image fusion](https://github.com/lxq-jnu/SpTFuse) SpTFuse | :white_check_mark: | PR              |
| **2025** | [RDMFuse: A Retinex Decomposition Model-Based Deep Framework for Infrared and Visible Image Fusion](https://github.com/wang-x-1997/RDMFuse) | :white_check_mark: | JSTSP           |
| **2024** | [EgeFusion: Towards Edge Gradient Enhancement in Infrared and Visible Image Fusion With Multi-Scale Transform](https://github.com/Haojie-Tang/EgeFusion)（matlab） | :white_check_mark: | TCI             |
| **2024** | [AGMFusion: A Real-Time End-to-End Infrared and Visible Image Fusion Network Based on Adaptive Guidance Module](https://github.com/liushh39/AGMFusion) | :white_check_mark: | Sens.  J 2      |
| **2024** | [TextFusion: Unveiling the Power of Textual Semantics for Controllable Image Fusion](https://github.com/AWCXV/TextFusion)（Text） | :white_check_mark: | InfFus          |
| **2024** | [Text-IF: Leveraging Semantic Text Guidance for Degradation-Aware and Interactive Image Fusion](https://github.com/XunpengYi/Text-IF)（Text） | :white_check_mark: | CVPR            |
| **2024** | [FILM: image Fusion via vIsion-Language Model](https://github.com/Zhaozixiang1228/IF-FILM) （Text） | :x:                | ICML            |
| **2024** | [TeRF: Text-driven and Region-aware Flexible Visible and Infrared Image Fusion](https://github.com/Baixuzx7/TeRF)（Text） | :x:                | ACM             |
| **2024** | [MVSFusion: infrared and visible image fusion method for multiple visual scenarios](https://github.com/VCMHE/MVSFusion) (matlab) | :x:                | Visual C. 3     |
| **2024** | [MMDRFuse: Distilled Mini-Model with Dynamic Refresh for Multi-Modality Image Fusion](https://github.com/yanglinDeng/MMDRFuse) | :white_check_mark: | ACM             |
| **2024** | [SHIP: Probing Synergistic High-Order Interaction in Infrared and Visible Image Fusion](https://github.com/zheng980629/SHIP) | :white_check_mark: | CVPR            |
